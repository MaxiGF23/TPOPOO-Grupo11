...
/*
Se trata de un sistema de gestión de empleados para una fábrica de aeronaves. La fábrica cuenta con dos líneas de producción:
 aeronaves de alas rotativas (helicópteros) y aeronaves de alas fijas (aviones).
